  ...
  const quickStats = [
    {
      ...
      change: { value: dashboardData?.stats.studentChange || 0, trend: 'up' as const },
      icon: (
    ...
    },
    {
      ...
      value: dashboardData?.stats.totalTeachers.toLocaleString() || '0',
      change: { value: dashboardData?.stats.teacherChange || 0, trend: 'up' as const },
      icon: (
        <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    {
      title: 'Total Classes',
      value: dashboardData?.stats.totalClasses.toLocaleString() || '0',
      icon: (
        <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    {
      title: 'Total Parents',
      value: dashboardData?.stats.totalParents.toLocaleString() || '0',
      change: { value: dashboardData?.stats.parentChange || 0, trend: 'up' as const },
      icon: (
        <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
